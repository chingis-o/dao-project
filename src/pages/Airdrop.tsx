    ...
    <div className="text-white">
      ...
      <div className="grid grid-cols-2">
        <div className="pr-14">
          ...
          <div className="bg-slate-700 rounded-lg p-5 pl-20 mb-10">
        ...
        <div className="pr-14">
          ...
          <div className="bg-slate-700 rounded-lg p-5 mb-5 pl-20">
            <div className="font-bold">Member</div>
            <div className="text-gray-500">1000 units available</div>
          </div>
          <div className="bg-slate-700 rounded-lg p-5 pl-20">
